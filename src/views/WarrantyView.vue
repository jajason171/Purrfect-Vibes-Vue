      ...
      <div class="max-w-[700px] mx-auto h-full">
        ...
        >
          <div class="text-left flex justify-between">
            <div class="">
              <h1>Bracelet not registered</h1>
              <p class="infoTitle">Register to make it yours</p>
            </div>
            <img
          ...
          >
            <img
              v-if="formstatus === 'register' || formstatus === 'complete'"
              alt="placeloder"
        ...
        <div
          v-auto-animate
          id="registerbtn"
          class="formdiv text-left rounded-t-[30px] flex flex-col justify-center"
          :class="formstatus === 'register' && 'h30'"
        >
          <div class="p-5">
            <h1 class="text-white">Amy Bracelet</h1>
            <h3 class="text-gray-300">Purchase on: 01 Oct 2022</h3>
            <p
            ...
            <div class="bg-white p-5 w-full text-black rounded-t-[30px]">
              ...
              >
                ...
                >
                  ...
                  <p v-if="formstatus === 'confirm'">146we f w5e4f</p>
                  <input
                    maxlength="25"
                    class="bg-gray-100 rounded-lg inputform my-2 py-1"
                    :class="
                ...
                >
                  <div class="flex flex-col">
                    ...
                    <div class="flex w-full justify-between">
                      <div class="w50">
                        <p class="infoTitle">Serial Number</p>
                        <p>{{ $route.params.serialnumber }}</p>
                      </div>
                      <div class="w50">
                        <p class="infoTitle">Price</p>
                        <p>฿1490.00</p>
                      </div>
                    </div>
                  </div>
                  <div class="flex flex-col">
                    ...
                    <div class="flex info">
                      <div class="w50">
                        <p class="infoTitle">Warranty Start</p>
                        <p>08-Oct-2022</p>
                      </div>
                      <div class="w50">
                        <p class="infoTitle">Duration</p>
                        <p>1 Year</p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="flex justify-around">
                  <button
                    ...
                    class="backbtn p-3 max-w-[200px] mt-5"
                  >
                    Back
                  </button>
                  <input
                    ...
                    type="submit"
                    value="Confirm"
                    class="bg-[#a4a4a4] text-white rounded-[15px] p-3 w-[100px] max-w-[200px] mt-5"
                  />

                  <button
                    v-if="formstatus === 'form'"
                    @click.prevent="CheckInputError()"
                    class="registerButton p-3 max-w-[200px] mt-5"
                  >
                    Register
                  </button>
                </div>
          ...
          >
            <button
              @click.prevent="setFormStatus('form'), scrollToEnd('registerbtn')"
              class="braceletButton p-3 max-w-[200px] mt-5"
            >
              Register Bracelet
            </button>
          </div>
